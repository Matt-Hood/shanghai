    ...
    <<<<<<< HEAD <!-- Navigation -->
        ...
        <div class="summary" id="summary">
            <div class="jumbotron">
                ...
                <img src="https://up-1.cdn-fullscreendirect.com/production/photos/10272/original/20170502_173225_10272_989344.jpeg">
                ...
                <p class="lead">
                    <a class="btn btn-primary btn-lg" href="https://www.bestbuy.com/site/one-more-light-live-cd/6165300.p?skuId=6165300&ref=212&loc=1&ksid=997fa4ba-1f82-4a1f-85ea-58a06b1224c0&ksprof_id=3&ksaffcode=pg218887&ksdevice=c&lsft=ref:212,loc:2&gclid=EAIaIQobChMI4LCBw-Lv1wIV1bjACh2KRQctEAQYASABEgJJh_D_BwE" role="button">PRE ORDER</a>
                </p>
            </div>
        </div>
        <!--<div class="summary" id="summary">
        ...
        <div class="summary" id="summary">
            ...
            <div id="summary" class="row align-items-center">
                <div class="column col-md-4 col-sm-4 col-xs-12">
                    ...
                    <<<<<<< HEAD <!--<img src="images/band.jpg" class="bandpic" alt="Linkin_Park">
                        =======
                        <img src="images/band.jpg" class="bandpic" alt="Linkin_Park"> >>>>>>> 3e87032ccdbc1ac2d866450abc69efda5b8be4cb
                </div>
            ...
            <div class="row align-items-center">
                ...
                <div class="column col-md-8 col-sm-8 col-xs-12">
                    ...
                    <ul>
                        ...
                        <audio controls>
  <source src="audio/Linkin%20Park%20-%20One%20Step%20Closer.mp3" type="audio/mpeg">
  Your browser does not support the audio tag.
</audio>
                        <li>"Crawling"</li>
                        <audio controls>
  <source src="audio/Linkin%20Park%20-%20Crawling.mp3" type="audio/mpeg">
  Your browser does not support the audio tag.
</audio>
                        <li>"In the End"</li>
                        <audio controls>
  <source src="audio/In%20the%20End-%20Linkin%20Park.mp3" type="audio/mpeg">
  Your browser does not support the audio tag.
</audio>
                    </ul>
                </div>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="column col-md-8 col-sm-8 col-xs-12">
                        ...
                        <ul>
                            <li>"Numb"</li>
                            <audio controls>
  <source src="audio/Linkin%20Park%20-%20Numb.mp3" type="audio/mpeg">
  Your browser does not support the audio tag.
</audio>
                        </ul>
                    </div>
            ...
            <div class="row align-items-center">
                ...
                <div class="column col-md-8 col-sm-8 col-xs-12">
                    ...
                    <ul>
                        <li>"Bleed It Out"</li>
                        <audio controls>
  <source src="audio/Linkin%20Park-Bleed%20it%20Out.mp3" type="audio/mpeg">
  Your browser does not support the audio tag.
</audio>
            ...
            <button onclick="myFunction()">More albums</button>
            ...
            <div class="row align-items-center">
                ...
                <div class="column col-md-8 col-sm-8 col-xs-12">
                    ...
                    <ul>
                        <li>"The Catalyst"</li>
                        <audio controls>
  <source src="audio/Linkin%20Park-The%20Catalyst.mp3" type="audio/mpeg">
  Your browser does not support the audio tag.
</audio>
            ...
            <div class="row align-items-center">
                ...
                <div class="column col-md-8 col-sm-8 col-xs-12">
                    ...
                    <ul>
                        <li>"Burn it Down"</li>
                        <audio controls>
  <source src="audio/Burn%20It%20Down-Linkin%20Park.mp3" type="audio/mpeg">
  Your browser does not support the audio tag.
</audio>
                ...
                <div class="column col-md-8 col-sm-8 col-xs-12">
                    ...
                    <ul>
                      <li>"Until It's Gone"</li>
                         <audio controls>
  <source src="audio/Linkin%20Park%20-%20Until%20Its%20Gone.mp3" type="audio/mpeg">
  Your browser does not support the audio tag.
</audio>
                ...
                <div class="column col-md-8 col-sm-8 col-xs-12">
                    ...
                    <ul>
                        <li>"One More Light"</li>
                         <audio controls>
  <source src="audio/Linkin%20Park%20-%20One%20More%20Light.mp3" type="audio/mpeg">
  Your browser does not support the audio tag.
</audio>
...
>>>>>>> 3e87032ccdbc1ac2d866450abc69efda5b8be4cb
        ...
        ?>
            ...
            <<<<<<< HEAD <?php=======< ?php>>>>>>> 3e87032ccdbc1ac2d866450abc69efda5b8be4cb include "inc/bottom.inc"; ?>