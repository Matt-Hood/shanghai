...
try {
    ...
    $mail->Host = 'smtp.gmail.com;pop.gmail.com';  // Specify main and backup SMTP servers
    $mail->SMTPAuth = true;                               // Enable SMTP authentication
    $mail->Username = 'flaimrider15@gmail.com';                 // SMTP username
    $mail->Password = 'toontown17';                           // SMTP password
    $mail->SMTPSecure = 'tls';                            // Enable TLS encryption, `ssl` also accepted
    $mail->Port = 587;                                    // TCP port to connect to

    //Recipients
    $mail->setFrom('from@example.com', 'Mailer');
    $mail->addAddress('matthood345@gmail.com', 'Joe User');     // Add a recipient
